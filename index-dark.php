...
<!-- Mirrored from pixydrops.com/aspro/main-php/index-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Feb 2024 11:13:49 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/php;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Dark || Aspro || HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="assets/vendors/aspro-icons/style.css">
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="assets/css/aspro.css" />
    <link rel="stylesheet" href="assets/css/aspro-responsive.css" />
    <link rel="stylesheet" href="assets/css/aspro-dark.css" />
</head>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                ...
                <div class="item main-slider__slide-1">
                    ...
                    <div class="container">
                        <div class="main-slider__content">
                            ...
                            <h2 class="main-slider__title">the brand <br> <span>uniqueness</span> <a href="about.php"
                                    class="main-slider__btn"><i class="icon-right-arrow1"></i></a></h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <h3 class="services-one__title"><a href="services-details.php">Website design</a>
                                    </h3>
                                ...
                                <div class="services-one__hover-content">
                                    <h3 class="services-one__hover-title"><a href="website-development.php">Website
                                            design</a>
                                    </h3>
                                    <p class="services-one__hover-text">This present moment is perfect simply due to the
                                        fact.</p>
                                    <div class="services-one__hover-arrow">
                                        <a href="website-development.php"><span class="icon-down-arrow"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <h3 class="services-one__title"><a href="services-details.php">App development</a>
                                    </h3>
                                    <div class="services-one__icon">
                                ...
                                <div class="services-one__hover-content">
                                    <h3 class="services-one__hover-title"><a href="app-development.php">App
                                            development</a>
                                    </h3>
                                    <p class="services-one__hover-text">This present moment is perfect simply due to the
                                        fact.</p>
                                    <div class="services-one__hover-arrow">
                                        <a href="app-development.php"><span class="icon-down-arrow"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="services-one__single">
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <h3 class="services-one__title"><a href="services-details.php">Digital
                                            marketing</a>
                                    </h3>
                                    <div class="services-one__icon">
                                ...
                                <div class="services-one__hover-content">
                                    <h3 class="services-one__hover-title"><a href="digital-marketing.php">Digital
                                            marketing</a>
                                    </h3>
                                    <p class="services-one__hover-text">This present moment is perfect simply due to the
                                        fact.</p>
                                    <div class="services-one__hover-arrow">
                                        <a href="digital-marketing.php"><span class="icon-down-arrow"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="about-one__right">
                            ...
                            <div class="about-one__btn-and-user-box">
                                <div class="about-one__btn-box">
                                    <a href="about.php" class="about-one__btn thm-btn">Find out more</a>
                                </div>
                                <div class="about-one__user-box">
                                    <div class="about-one__user-img">
                                        <img src="assets/images/resources/abot-one-user-img-1.jpg" alt="">
                                    </div>
                        ...
                        <div class="portfolio-one__single">
                            <div class="portfolio-one__img-box">
                                ...
                                <div class="portfolio-one__content">
                                    ...
                                    <h3 class="portfolio-one__title"><a href="portfolio-details.php">Asus marketing</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="team-one__single">
                            <div class="team-one__img-box">
                                ...
                                <div class="team-one__share-btn">
                                    <a href="team-details.php"><span class="fas fa-share-alt"></span></a>
                            ...
                            <div class="team-one__content">
                                <div class="team-one__name-box">
                                    <h3><a href="team-details.php">Mike hardson</a></h3>
                                    <p>Developer</p>
                                </div>
                                <div class="team-one__arrow">
                                    <a href="team-details.php"><span class="icon-right-lg-arrow"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <div class="team-one__name-box">
                                    <h3><a href="team-details.php">Aleesha brown</a></h3>
                                    <p>Designer</p>
                                </div>
                                <div class="team-one__arrow">
                                    <a href="team-details.php"><span class="icon-right-lg-arrow"></span></a>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <div class="team-one__name-box">
                                    <h3><a href="team-details.php">Kevin martin</a></h3>
                                    <p>Manager</p>
                                </div>
                                <div class="team-one__arrow">
                                    <a href="team-details.php"><span class="icon-right-lg-arrow"></span></a>
        ...
        <section class="contact-one">
            <div class="contact-one__shape-5 float-bob-x">
                <img src="assets/images/shapes/contact-one-shape-5-dark.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="contact-one__left">
                            ...
                            <div class="contact-one__img">
                                ...
                                <div class="contact-one__shape-2">
                                    <img src="assets/images/shapes/contact-one-shape-2-dark.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="contact-one__right">
                            ...
                            <div class="contact-one__form-box">
                                <form action="https://pixydrops.com/aspro/main-php/assets/inc/sendemail.php" class="contact-one__form contact-form-validated"
                        ...
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <div class="blog-one__title-box">
                                    <h3 class="blog-one__title"><a href="blog-details.php">Trending code settings for
                                            a</a>
                                    </h3>
                                    <h3 class="blog-one__title"><a href="blog-details.php">nice portfolio</a></h3>
                                </div>
                                <div class="blog-one__btn-box">
                                    <a href="blog-details.php"><span class="icon-right-lg-arrow"></span></a>
                                    <a href="blog-details.php" class="blog-one__btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="blog-one__single blog-one__single-2">
                            ...
                            <div class="blog-one__content">
                                ...
                                <div class="blog-one__title-box">
                                    <h3 class="blog-one__title"><a href="blog-details.php">It’s through refresing
                                            to</a>
                                    </h3>
                                    <h3 class="blog-one__title"><a href="blog-details.php">get such a personal</a></h3>
                                </div>
                                <div class="blog-one__btn-box">
                                    <a href="blog-details.php"><span class="icon-right-lg-arrow"></span></a>
                                    <a href="blog-details.php" class="blog-one__btn">Read More</a>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="blog-one__single blog-one__single-3">
                            ...
                            <div class="blog-one__content">
                                ...
                                <div class="blog-one__title-box">
                                    <h3 class="blog-one__title"><a href="blog-details.php">Due to their excellent
                                            service</a>
                                    </h3>
                                    <h3 class="blog-one__title"><a href="blog-details.php">competitive pricing</a></h3>
                                </div>
                                <div class="blog-one__btn-box">
                                    <a href="blog-details.php"><span class="icon-right-lg-arrow"></span></a>
                                    <a href="blog-details.php" class="blog-one__btn">Read More</a>
            ...
            <div class="container">
                <div class="cta-one__inner">
                    ...
                    <div class="cta-one__arrow">
                        <a href="contact.php"><span class="icon-right-lg-arrow"></span></a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index-2.php" aria-label="logo image"><img src="assets/images/resources/logo-1.png" width="40"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <!-- template js -->
    <script src="assets/js/aspro.js"></script>
</body>


<!-- Mirrored from pixydrops.com/aspro/main-php/index-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Feb 2024 11:13:56 GMT -->
</php>